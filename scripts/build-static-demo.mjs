...
import { syncCore } from './sync-intake-core.mjs';
await syncCore();
const output = new URL('../docs/', import.meta.url), source = new URL('../public/', import.meta.url);
await mkdir(output, { recursive: true });
for (const name of ['app.mjs','intake.mjs','intake-core.mjs','assemblyai-config.mjs','tool-results.mjs','recording.mjs','audio-worklet.js','style.css']) await copyFile(new URL(name, source),new URL(name, output));
