...
s=slide('05','Verified September 8, 2026','Live browser capture and correction\npassed with synthesized speech.');
card(s,.65,3.3,3.8,2.7,'26 local tests','Intake rules, HTTP boundaries, audio resampling and parallel tool-result delivery.');
...
text(s,'Recorded from the public live app. Microphone connection also checked; broader speaker testing is future work.',.7,6.4,12,.4,16,C.soft);
...
card(s,6.75,3.3,5.9,2.65,'Next evaluation','More accents and noisy microphones.\nService-business usability feedback.\nOptional business-side delivery.');
